...
all_num=0
goal_num=0
for x in combinations_with_replacement([i+1 for i in range(13)], 4):
    all_num+=1
    #if all_num < 1136:
    #    continue
    one_poker=list(x)
    print all_num, "--", one_poker, "--", goal_num
    goal_num+=p24(one_poker,4)

print "total goal num is", goal_num
